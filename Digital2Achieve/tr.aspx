    ...
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="tr.aspx"><img src="assets/img/Language/turkey.png" alt=""/></a></li>
          <li><a class="nav-link scrollto" href="index.aspx"><img src="assets/img/Language/united-kingdom.png"
                alt=""/></a>
          </li>
        </ul>
    ...
    <section id="cta" class="cta quote-text-color">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <h3 style="color: rgb(216 215 205);">
            İŞİNİZ İNTERNETTE YOKSA İŞİNİZ TUTMAZ
            <br>
          ...
          <div class="row mt-3 justify-content-center">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up">
                ...
                <h3 class="description" style="color: rgb(216 215 205);"> <br />
                    <br />
              ...
              <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="description">
                  ...
                  <button type="button" class="btn" style="width:100%" data-bs-toggle="modal"
                    data-bs-target="#staticBackdrop"><i class="fa-regular fa-file-lines float-start p-1"></i>
                    <h3 class="description" style="color: rgb(216 215 205);"><br/><br/>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" style="margin-left: 85px;">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                ...
                <p class="description">
                  ...
                  <!-- Button trigger modal -->
                  <button type="button" class="btn" style="width:100%;" data-bs-toggle="modal"
                    data-bs-target="#staticBackdropp"><i class="fa-regular fa-file-lines float-start p-1"></i>
                    <h3 class="description" style="color: rgb(216 215 205);"><br><br>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <h3 style="color: rgb(216 215 205);">Zor zamanlarda pazarlama bir lüks değil, bağlantı kurmak için bir
            gerekliliktir
            İzleyicilerle etkileşime geçin ve markaya güven ve sadakat oluşturun. <br>
          ...
          <div class="row mt-3 justify-content-center">
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up">
                ...
                <h4 class="title"><a href="TR/PotansiyelMusteriolusturma.aspx">POSTANSİYEL MÜŞTERİ OLUŞTURMA VE
                    PAZARLAMA</a></h4>
                <p class="description">Potansiyel müşteri oluşturma pazarlaması, bir ürüne, hizmete veya teklife ilgi
                  gösteren bireylerden iletişim bilgilerini veya diğer...</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                <div class="icon"><i class='bx bxl-meta'></i></div>
                <h4 class="title"><a href="TR/SosyalMedyaYonetimi.aspx">SOSYAL MEDYA YÖNETİMİ</a></h4>
                <p class="description">Sosyal medya yönetimi (Facebook, Instagram, Twitter, LinkedIn vb.), sosyal medya
                  platformlarını kullanarak marka bilinirliğini artırma...</p>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                ...
                <h4 class="title"><a href="TR/WebTasarimVeGelistirme.aspx">WEB TASARIM VE GELIŞTIRME</a></h4>
                <p class="description">Web tasarımı ve geliştirme, bir web sitesinin görsel tasarımını, kullanıcı
                  arayüzünü ve kullanıcı deneyimini belirli...
                </p>
              </div>
            </div>
          </div>
          <div class="row mt-4 justify-content-center">
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                ...
                <h4 class="title"><a href="TR/SeoAramaMotoruOptimizasyonu.aspx">SEO(ARAMA MOTORU VE OPTIMIZASYON)</a>
                </h4>
                <p class="description">SEO, bir web sitesinin arama motorlarında organik olarak üst sıralarda
                  görünmesini sağlayan bir dizi teknik ve stratejik...</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                <div class="icon"><i class='bx bxl-google'></i></div>
                <h4 class="title"><a href="TR/GoogleAdsPazarlama.aspx">GOOGLE ADS (PAZARLAMA)</a></h4>
                <p class="description">Google Ads (önceden AdWords olarak bilinir), Google tarafından sunulan bir reklam
                  platformudur. </p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                ...
                <h4 class="title"><a href="TR/Markalasma.aspx">MARKALAŞMA</a></h4>
                <p class="description">Markalaşmak, bir şirketin veya firmanın kendini benzersiz ve tanınabilir bir
                  şekilde pazarlamasını, müşterilerin zihinlerinde özel bir konum oluşturmasını ve diğer...</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                <div class="icon"><i class='bx bxs-data'></i></div>
                <h4 class="title"><a href="TR/">VERİ ANALİZİ VE RAPORLAMA</a></h4>
                <p class="description"> Dijital dünyada şirketinizin pazarlama yöntemlerinin etkin bir şekilde
                  değerlendirilmesi kritik bir öneme sahiptir. Sosyal Medya Yönetimi, İçerik...
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <h3>İçeriği ve hikayesi olan iyi organize edilmiş bir web sitesi, binlerce kişiyi dönüştürebilir.
            tanımadığınız insanları markanıza sadık bir müşteri tabanına dönüştürün <br/>
            <h5>-Erdogan Tabur </h5>
          </h3>
        </div>
