...
<body>
        ...
        <div class="container d-flex align-items-center justify-content-between position-relative">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="../EN/GoogleAdvertisements.aspx">
    ...
    <main id="main">
        ...
        <section class="inner-page">
            <div class="container">
                        <h4 style="text-align: center; font-size:30pt;">GOOGLE ADS (ADWORDS)</h4>
                        <hr />
                <div class="row">
                ...
                <p class="align-items-center">
                  ...
                  advertisers comprehensive targeting options.
                    ...
                    according to the types of devices suitable for advertising.</li>
                                    <li class="mt-3">Allows you to change the budget and targeting options of advertising campaigns
                    at any time.</li>
                                    <li class="mt-3">From the moment the advertisements are published, they can reach potential
                    customers and reach your target audience.</li>
                                    <li class="mt-3">It is easy for you to determine the advertising budget and pay according to the
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3  footer-links container"  margin-top: 38px">
                        <ul>
