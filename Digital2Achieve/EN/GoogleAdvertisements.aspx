<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoogleAdvertisements.aspx.cs" Inherits="Digital2Achieve.EN.GoogleAdvertisements" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Digital2Achieve - Google ADS</title>
    ...
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../TR/GoogleAdsPazarlama.aspx"><img src="../assets/img/Language/turkey.png" alt=""/></a></li>
          <li><a class="nav-link scrollto" href="../EN/GoogleAdvertisements.aspx"><img src="../assets/img/Language/united-kingdom.png" alt=""/></a></li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 mt-5">
            ...
            <p class="align-items-center">Google Ads, previously known as AdWords,
          ...
          <div class="row mt-3">
            <div class="col-md-12">
              <h4 style="text-align: center;">What is the importance of Google Ads?</h3>
                <p class="align-items-center">Google Ads offers
                  advertisers comprehensive targeting options.</p>
                <ul>
                  <li class="mt-3">Find potential customers based on interests, location, language,
                    and demographics.</li>
                  <li class="mt-3">It enables the display of advertisements to the target audience
                    according to the types of devices suitable for advertising.</li>
                  <li class="mt-3">
                    Allows you to change the budget and targeting options of advertising campaigns
                    at any time.</li>
                  <li class="mt-3">
                    From the moment the advertisements are published, they can reach potential
                    customers and reach your target audience.</li>
                  <li class="mt-3">
                    It is easy for you to determine the advertising budget and pay according to the
                    impressions and clicks of the advertisements.</li>
                </ul>
            </div>
          </div>
          ...
          <div class="row mt-4">
            <div class="col-md-9">
              <h4 style="text-align: center;">What do we do for you?</h3>
                <p class="align-items-center"> <span
                    style="font-weight: 900;color: brown;">Digital2Achieve</span>,Digital Marketing,
                  we take pride in identifying your target audience and connecting them with your
                  products or services. By implementing effective Google Ads strategies and optimizing
                  the right keywords, we aim to increase brand awareness and drive sales.
                  Additionally, we regularly monitor performance to ensure that you are getting the
