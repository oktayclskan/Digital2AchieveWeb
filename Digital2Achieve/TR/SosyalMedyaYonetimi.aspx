<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SosyalMedyaYonetimi.aspx.cs" Inherits="Digital2Achieve.TR.SosyalMedyaYonetimi" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Digital2Achieve - Sosyal Medya Yönetimi</title>
            ...
            <div class="col-md-9">
              <h4 style="text-align: center;">Biz sizin için ne yapıyoruz?</h4>
                <p class="align-items-center"> Dijitalle Başar <span
                  ...
                  aldığımız bilgi ve beklentilerle hedef kitle analizi, içerik planlaması yapıyor ve yayınlıyoruz.

                  Markanızın sosyal medya hesaplarını yönetiyor, içerik üretiyor, sosyal medya kampanyalarınızı
                  yönetiyoruz.
                </p>
            </div>
            <div class="col-md-3 mt-4">
