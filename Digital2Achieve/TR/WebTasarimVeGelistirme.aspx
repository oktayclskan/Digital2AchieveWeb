<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebTasarimVeGelistirme.aspx.cs" Inherits="Digital2Achieve.TR.WebTasarimVeGelistirme" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Digital2Achieve - Web Tasarım ve Geliştirme</title>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <div class="logo">
        <a href="../index.aspx"><img src="../assets/img/Logo/d2a-head-logo2.png" width="110"/></a>
      </div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../TR/WebTasarimVeGelistirme.aspx"><img src="../assets/img/Language/turkey.png" alt=""/></a></li>
          <li><a class="nav-link scrollto" href="../EN/WebDeisgnAndDevelopment.aspx"><img src="../assets/img/Language/united-kingdom.png" alt=""/></a></li>
        </ul>
  ...
  <main id="main">
    <section class="inner-page">
      <div class="container">
            <h4 style="text-align: center; font-size: 30pt;">WEB TASARIM GELİŞTİRME</h4>
              <hr />
        <div class="row">
            ...
            <div class="col-md-12">
              <h4 style="text-align: center;">
                ...
                <ul>
                  ...
                  <li class="mt-3">
                    Hedef kitleyle etkileşim kurmayı sağlar. </li>
                  <li class="mt-3">
                    İyi işletmelerin dijital varlığını güçlendirir.</li>
                  <li class="mt-3">
                    Global çapta varlığın dijital adresidir.</li>
                </ul>
            </div>
          </div>
            ...
            <div class="col-md-9">
              <h4 style="text-align: center;">Biz sizin için ne yapıyoruz?</h4>
                <p class="align-items-center"> Dijitalle Başar <span
                    style="font-weight: 900;color: brown;">Digital2Achieve</span> ekibi olarak web tasarımında uzman,
                  tecrübeli ve profesyonel tasarımcılarımızla, renklerin dilini, tipografiyi, görseller ve diğer grafik
                  unsurlarını birbiriyle uyumlu bir şekilde kullanarak web sitenizin sizi yansıtan sanat eserlerine
                  dönüşmesini sağlıyoruz. Bununla da kalmıyor, şirketinizin müşterilere olan mesajlarını en iyi şekilde
