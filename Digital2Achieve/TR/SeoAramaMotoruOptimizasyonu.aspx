...
<body>
    ...
    <main id="main">
        ...
        <section class="inner-page">
            <div class="container">
                <h4 style="text-align: center; font-size: 20pt;">SEO (ARAMA MOTORU OPTIMIZASYONU)</h4>
                <hr />
                <div class="row">
              ...
              bütünüdür.
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <h4 style="text-align: center;">SEO’NUN KISACA ÖNEMI NEDIR?</h4>
                            <ul>
                                ...
                                <li class="mt-3">Web sitenize organik müşteri trafiği çekmenizi sağlar.</li>
                                <li class="mt-3">Rakiplerinizin önünde yer almanızı sağlar.</li>
                                <li class="mt-3">Web sitenizin dönüşüm oranlarını artırır, daha fazla satış potansiyelini artırır.</li>
                            </ul>
                        </div>
                    </div>
