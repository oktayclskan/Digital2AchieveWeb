<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeoAramaMotoruOptimizasyonu.aspx.cs" Inherits="Digital2Achieve.TR.SeoAramaMotoruOptimizasyonu" %>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 mt-1">
            <img src="../assets/img/gif/SEO.gif" style="opacity: 0.7;" class="img-fluid w-50" />
          </div>
            ...
            <div class="col-md-12">
              <h4 style="text-align: center;">
                ...
                <ul>
                  ...
                  <li class="mt-3">
                    Web sitenize organik müşteri trafiği çekmenizi sağlar.</li>
                  <li class="mt-3">
                    Rakiplerinizin önünde yer almanızı sağlar.</li>
                  <li class="mt-3">
                    Web sitenizin dönüşüm oranlarını artırır, daha fazla satış potansiyelini artırır.</li>
                </ul>
            </div>
          </div>
            ...
            <div class="col-md-9">
              <h4 style="text-align: center;">Biz sizin için ne yapıyoruz?</h4>
                <p class="align-items-center"> Dijitalle Başar <span
                  ...
                  seviyelere çıkararak genel başarınızın artmasını sağlıyoruz.
                </p>
            </div>
            <div class="col-md-3 mt-1">
