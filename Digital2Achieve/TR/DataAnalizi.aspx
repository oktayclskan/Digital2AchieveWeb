<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataAnalizi.aspx.cs" Inherits="Digital2Achieve.TR.DataAnalizi" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="text-white mt-5" >
                            ...
                            veri toplama yöntemleri ile elde ettiğimiz verileri anlamlı raporlara dönüştürerek,
                            müşterilerimizin dijital varlıklarının performansını aylık olarak açık ve ölçülebilir bir
                            şekilde size sunuyoruz.
                        </p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-6 mt-5">
                        <p class="mt-5" >
                            ...
                            büyüdüğünü net bir şekilde görmelerini sağlıyoruz.

                            Sizi de etkili veri analizi ve raporlama ile dijital başarınızı maksimize etmek için sizi
                            Dijitalle Başar (Digital2Achieve) ve çözümlerimizle tanışmaya davet ediyoruz. İletişime
                            geçerek şirketinizin ihtiyacı olan sonuca ulaşması için hemen bizimle iletişime geçin,
                            birlikte başarıya giden yolda adımları birlikte atalım.
