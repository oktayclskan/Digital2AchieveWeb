      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 mt-4">
            ...
            <p class="align-items-center">Potansiyel müşteri oluşturma pazarlaması,
          ...
          <div class="row mt-3">
            <div class="col-md-12">
              <h4 style="text-align: center;">
                Potansiyel müşteri oluşturma pazarlamasının önemi nedir?</h4>
                <ul>
                  ...
                  <li class="mt-3">
                    İçerikle pazarlama günümüz dünyasının en etkili ve uzun vadeli bir pazarlama stratejisidir.</li>
                </ul>
            </div>
          </div>
            ...
            <div class="col-md-9">
              <h4 style="text-align: center;">Biz sizin için ne yapıyoruz?</h4>
                <p class="align-items-center">
                  Dijitalle Başar <span style="font-weight: 900;color: brown;">
                    (Digital2Achieve)</span>Pazarlama ve Danışmanlık olarak biz sizin için içerik pazarlaması ile, hedef
