<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Markalasma.aspx.cs" Inherits="Digital2Achieve.TR.Markalasma" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Digital2Achieve - Markalaşma</title>
          ...
          <div class="row mt-3">
            <div class="col-md-12">
              <h4 style="text-align: center;">
                Markalaşmanın kısaca önemi nedir?</h4>

                <ul class="text-white">
                  <li class="mt-3">Rakiplerinden ayrıştırır ve rekabet üstünlüğü sağlar.</li>
                  <li class="mt-3">
                    <p class="align-items-center mt-2">Güven ve itibar oluşturur.
                    </p>
                  </li>
                  <li class="mt-3">
                    Müşterilerinizin gözünde değer yaratır ve fiyatlandırma gücü oluşturur.</li>
                  <li class="mt-3">
                    Müşteri bağlılığı ve sadakati oluşturur.</li>
                  <li class="mt-3">
                    Uzun vadeli başarı ve büyüme potansiyelini artırır.</li>
                </ul>
            </div>
          </div>
            ...
            <div class="col-md-9">
              <h4 style="text-align: center;">Biz sizin için ne yapıyoruz?</h3>
                <p class="align-items-center"> Dijital dünyanın gelişimiyle birlikte
                  ...
                  Pazarlama ve Danışmanlık olarak markanızın dijital dünyada yüksek bir sesle konuşmasını sağlıyoruz.
                  Sunduğumuz özgün çözümlerle markalaşma stratejinizi güçlendiriyor, marka bilinirliğinizi artırarak
                  piyasa varlığınızı zirveye taşıyoruz.
                </p>
            </div>
            <div class="col-md-3 mt-4">
